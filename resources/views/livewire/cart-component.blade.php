    ...
    <div class=" main-content-area">
            ...
            <ul class="products-cart">
                ...
                <li class="pr-cart-item">
                    <div class="product-image">
                        <figure><img src="{{asset('assets/images/products')}}/{{$item->model->featured_image}}" alt="{{$item->model->name}}"></figure>
                    </div>
                    <div class="product-name">
                        <a class="link-to-product text-capitalize" href="{{route('product.detail',$item->model->slug)}}">{{$item->model->name}}</a>
                    </div>
        ...
        <div class="summary">
            ...
            <div class="update-clear">
                <a class="btn btn-clear" href="#" wire:click.prevent="deleteAllItems()">Clear Shopping Cart</a>
