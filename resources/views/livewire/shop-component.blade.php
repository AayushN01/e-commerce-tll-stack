    ...
    <div class="row">
                        ...
                        <div class="product product-style-3 equal-elem ">
                            <div class="product-thumnail">
                                <a href="{{route('product.detail',$product->slug)}}" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                    <figure><img src="{{asset('assets/images/products')}}/{{$product->featured_image}}" alt="{{$product->name}}"></figure>
                                </a>
                            </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
                ...
                <div class="widget-content">
                    <ul class="list-category">
                        ...
                        <li class="category-item">
                            <a href="{{route('product.category',$category->slug)}}" class="cate-link text-capitalize">{{$category->name}} ({{$category->products->count()}})</a>
                        </li>
                        @endforeach
            ...
            <div class="widget mercado-widget filter-widget price-filter">
                <h2 class="widget-title">Price <span class="text text-info">${{$min_price}} - ${{$max_price}}</span></h2>
                <div class="widget-content">
                    <div id="slider" wire:ignore></div>
                </div>
            </div><!-- Price-->

            <div class="widget mercado-widget filter-widget" style="padding-top:30px;">
