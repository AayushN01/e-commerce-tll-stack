                ...
                <div class="panel-body table-responsive">
                    ...
                    <form action="#" class="form-horizontal" wire:submit.prevent="updateProduct()">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="file" class="form-control input-file" name="featured_image" wire:model="newImage">
                                @if($newImage)
                                <img src="{{$newImage->temporaryUrl()}}" alt="" width="120">
                                @else
                                <img src="{{asset('assets/images/products')}}/{{$featured_image}}" alt="" width="120">
                                @endif
                            </div>
                        </div>
                        <div class="form-group">
