<div class="container">
    ...
    <div class="wrap-breadcrumb">
        <ul>
            ...
            <li class="item-link"><a href="#" class="link">Product</a></li>
            <li class="item-link"><span>{{$product->category->name}}</span></li>
        </ul>
    </div>
    <div class="row">
                ...
                <div class="detail-media">
                    <div class="product-gallery">
                      <ul class="slides">
                        ...
                        <li data-thumb="{{asset('assets/images/products')}}/{{$product->featured_image}}">
                            <img src="{{asset('assets/images/products')}}/{{$product->featured_image}}" alt="{{$product->name}}" loading="lazy"/>
                        </li>
                            ...
                            <div class="product product-widget-style">
                                <div class="thumbnnail">
                                    <a href="{{route('product.detail',$product->slug)}}" title="{{$product->name}}">
                                        <figure><img src="{{asset('assets/images/products')}}/{{$product->featured_image}}" alt="{{$product->name}}" loading="lazy"></figure>
                                    </a>
                                </div>
                    ...
                    <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}' >
                        ...
                        <div class="product product-style-2 equal-elem ">
                            <div class="product-thumnail">
                                <a href="{{route('product.detail',$product->slug)}}" title="{{$product->name}}">
                                    <figure><img src="{{asset('assets/images/products')}}/{{$product->featured_image}}" width="214" height="214" alt="{{$product->name}}" loading="lazy"></figure>
                                </a>
